...
<body class="font-sans text-gray-900 antialiased">
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100 px-4">
        <div class="flex flex-col items-center">
            ...
            <h1 class="text-3xl font-bold text-gray-900 mt-4">Dashboard Admin</h1>
            <p class="text-gray-500 mt-2">Sign in to your account</p>
        </div>

        <div class="w-full sm:max-w-md mt-8 px-6 py-8 bg-white shadow-lg overflow-hidden rounded-xl">
            <!-- Session Status -->
