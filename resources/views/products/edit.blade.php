                    ...
                    <form action="{{ route('products.update', $product) }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <input type="text" name="icon" id="icon" value="{{ old('icon', $product->icon) }}" placeholder="fas fa-box"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <input type="text" name="tag" id="tag" value="{{ old('tag', $product->tag) }}" placeholder="Best Seller"
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
                                @error('tag')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <input type="color" name="tag_color" id="tag_color" value="{{ old('tag_color', $product->tag_color ?? '#3B82F6') }}"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="price_display" id="price_display" value="{{ old('price_display', $product->price_display) }}" placeholder="Rp 100.000"
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
                                @error('price_display')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <input type="text" name="price_unit" id="price_unit" value="{{ old('price_unit', $product->price_unit) }}" placeholder="/month"
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
                                @error('price_unit')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <input type="text" name="estimation" id="estimation" value="{{ old('estimation', $product->estimation) }}" placeholder="1-3 days"
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
                                @error('estimation')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
